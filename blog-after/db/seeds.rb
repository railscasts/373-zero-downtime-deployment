batman = Article.create! name: "Batman", published_on: 2.days.ago, content: <<-ARTICLE
...
superman = Article.create! name: "Superman", published_on: 5.days.ago, content: <<-ARTICLE
...
krypton = Article.create! name: "Krypton", published_on: 8.days.ago, content: <<-ARTICLE
...
lex_luthor = Article.create! name: "Lex Luthor", published_on: 12.days.ago, content: <<-ARTICLE
...
robin = Article.create! name: "Robin", published_on: 16.days.ago, content: <<-ARTICLE
